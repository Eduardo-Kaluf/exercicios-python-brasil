...
local_do_arquivo = input("Insira a pasta do arquivo: ")

base = os.getcwd()

try:
    arquivo = open(os.path.join(f"{base}", "Aulas_de_Python", f"{local_do_arquivo}", "ex_2_dos_arquivos.txt"), "r")
except:
...
saida = open(os.path.join(f"{base}", "Aulas_de_Python", "arquivos", "relatório"), "w", encoding="utf-8")
